...
<head>
    ...
    <title>JobHub - Employer Dashboard</title>
...
<body>
        ...
        <div class="hero-container">
            <div class="hero-content">
                <div class="hero-text animate-fade-in">
                    ...
                    <p>Find the perfect candidates for your company. Post jobs, review applications, and build your dream team.</p>
    ...
    <section class="welcome-section">
        <div class="welcome-container">
            ...
            <p>Manage your job postings, review applications, and connect with talented candidates.</p>
        ...
        <div class="actions-container">
            ...
            <div class="actions-grid">
                <div class="action-card">
                    ...
                    <h3>Post New Job</h3>
                    <p>Create and publish new job opportunities to attract top talent for your company.</p>
                ...
                <div class="action-card">
                    ...
                    <p>Search through candidate profiles and resumes to find the perfect match for your positions.</p>
                    <a href="#" class="btn btn-outline">View Candidates</a>
                </div>
                ...
                <div class="action-card">
                    ...
                    <h3>Analytics</h3>
                    <p>Track your job posting performance and candidate engagement metrics.</p>
