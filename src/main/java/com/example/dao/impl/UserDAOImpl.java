...
public class UserDAOImpl implements UserDAO {
	...
	public List<User> findByRole(String role) {
		return getSession().createQuery("FROM User u WHERE u.role = :role", User.class).setParameter("role", role)
				.getResultList();
	}
	...
	public boolean emailExists(String email) {
		...
		return getSession().createQuery(hql).setParameter("email", email).uniqueResult() != null;
	}
